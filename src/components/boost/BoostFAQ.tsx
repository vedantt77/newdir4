...
const faqItems = [
  {
    ...
    answer: 'Once you select a plan, our team will review your submission within 24 hours. After approval, your startup will be featured according to your chosen package benefits.'
  },
  {
